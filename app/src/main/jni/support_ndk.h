 ...
 * LongのFieldIdを読み込む
 */
extern jfieldID ndk_loadLongField(JNIEnv *env, jclass clazz, const char* field_name);
 ...
 * String
 */
extern jfieldID ndk_loadStringField(JNIEnv *env, jclass clazz, const char* field_name);
